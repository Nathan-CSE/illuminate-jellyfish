...
void sendBit(unsigned char bitVal) {
    if(bitVal) {
        ...
        PORTCbits.RC0 = 1;
        _delay((unsigned long)((0.7)*(4000000/4000000.0)));
        PORTCbits.RC0 = 0;
        _delay((unsigned long)((0.6)*(4000000/4000000.0)));
    } else {

        PORTCbits.RC0 = 1;
        _delay((unsigned long)((0.35)*(4000000/4000000.0)));
        PORTCbits.RC0 = 0;
        _delay((unsigned long)((0.8)*(4000000/4000000.0)));
    }
}
